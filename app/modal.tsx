...
//         `INSERT INTO users (listName, email, image) VALUES (?, ?, ?)`,
//         [listName, email, ""]
//       );
...
//     try {
//       const response = await database.runAsync(
//         `UPDATE users SET listName = ?, email = ? WHERE id = ?`,
//         [listName, email, parseInt(id as string)]
//       );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ flex: 1, flexDirection: "row", gap: 20 }}>
        <TouchableOpacity
          onPress={() => router.back("/VocabListPage")}
